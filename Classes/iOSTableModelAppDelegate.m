//
//  iOSTableModelAppDelegate.m
//  iOSTableModel
//
//  Created by Jesse Andersen on 10/18/10.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSString *modelPath = [[NSBundle mainBundle] pathForResource:@"iOSTableModel" ofType:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [NSURL fileURLWithPath: [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"iOSTableModel.sqlite"]];
